...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
     ...
     */
    #[ORM\OneToMany(targetEntity: UserTVShow::class, mappedBy: 'user')]
    private Collection $userTVShows;

    /**
     * @var Collection<int, UserFilm>
     */
    #[ORM\OneToMany(targetEntity: UserFilm::class, mappedBy: 'user')]
    ...
    public function removeUserTVShow(UserTVShow $userTVShow): static
    {
        if ($this->userTVShows->removeElement($userTVShow)) {
            ...
            if ($userTVShow->getUser() === $this) {
                $userTVShow->setUser(null);
            }
        }
